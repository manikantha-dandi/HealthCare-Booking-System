...
<html>
    ...
    <body style="background-image: url(Pictures/Pic12.jpg);">
	<div class="header">
    <ul>
        <li style="float: left; border-right: none;"> <a href="Home.php" class="logo"> <strong>  HealthCare Booking System </a> </li>
        <li> <a href="Home.php"><strong> HOME </strong></a></li>
		<li> <a href="Login.php"><strong> BACK </strong></a></li>
    </ul>
    </div>
	<form action="Booking.php" method="post">
	<div class="sucontainer" style="background-image:url(Pictures/Pic12.jpg)">

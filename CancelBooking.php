<html>
    ...
    </head> <?php $conn = mysqli_connect('localhost','root','root','appointment'); ?>
    <body style="background-image: url(Pictures/Pic6.jpg);">
        <div class="header">
            <ul>
                <li style="float: left; border-right: none;"><a href="Login.php" class="logo"><img src="Pictures/Pic9.png" width="70px" height="60px"> HealthCare Booking System </a></li>
